...
'''},
{'date': 'Mon Aug 01 2022 10:47:30.323 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 40
    self.imagem.vai()
AttributeError: 'Camara' object has no attribute 'imagem'
'''},
{'date': 'Mon Aug 01 2022 10:47:47.315 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module _spy.vitollino.main line 1331
    self.cena.elt <= Popup.POP.popup
AttributeError: 'Camara' object has no attribute 'elt'
'''},